...
const Metric = ({ parameter, percent }) => {
    return (
...
const Evaluation = () => {
    ...
    return (
        evaluation.keyword === 0 || evaluation.semantics === 0 ?
        <EvaluationSkeleton /> :
        <div className="Evaluation">
            ...
            <div className="Metrics">
                <Metric parameter="Keywords" percent={Math.round(evaluation.keyword * 100)} />
                <Metric parameter="Semantics" percent={Math.round(evaluation.semantics * 100)} />
                <Metric parameter="Relevance" percent={23} />
            </div>
        </div>
    )
}
